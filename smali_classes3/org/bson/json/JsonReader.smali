...
.method private visitBinDataExtendedJson(Ljava/lang/String;)Lorg/bson/BsonBinary;
    ...
    const-string v1, "Unexpected key for $binary: "

    .line 967
    new-instance v2, Lorg/bson/json/JsonReader$Mark;

    invoke-direct {v2, p0}, Lorg/bson/json/JsonReader$Mark;-><init>(Lorg/bson/json/JsonReader;)V
    ...
    .line 998
    new-instance v1, Lorg/bson/BsonBinary;

    invoke-direct {v1, v0, p1}, Lorg/bson/BsonBinary;-><init>(B[B)V
    :try_end_1
...
.method private visitDateTimeConstructor()J
    ...
    invoke-virtual {v1, v6}, Lorg/bson/json/JsonToken;->getValue(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private visitISODateTimeConstructor()J
    ...
    invoke-virtual {v0, v5}, Lorg/bson/json/JsonToken;->getValue(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 854
    invoke-virtual {v2, v6}, Ljava/text/SimpleDateFormat;->setLenient(Z)V
...
.method private visitTimestampConstructor()Lorg/bson/BsonTimestamp;
    ...
    sget-object v5, Lorg/bson/json/JsonTokenType;->INT32:Lorg/bson/json/JsonTokenType;
...
.method public readBsonType()Lorg/bson/BsonType;
    ...
    invoke-virtual {p0, v3}, Lorg/bson/json/JsonReader;->setCurrentBsonType(Lorg/bson/BsonType;)V
    ...
    :cond_1d
    :goto_2
    sget-object v3, Lorg/bson/BsonType;->BOOLEAN:Lorg/bson/BsonType;
